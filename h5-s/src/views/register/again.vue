...
export default {
  ...
  methods: {
    getLogin() {
      ...
      businessreviewLogin(params).then((res) => {
        if (res.code == 200) {
      ...
      businessreviewInfo(params).then((res) => {
        if (res.code == 200) {
          ...
          if (this.infoForm.logo) {
            requestImage(this.IMG_BASR_URL + this.infoForm.logo).then(
              (result) => {
                let str = {
                  content: result,
                };
          ...
          if (this.infoForm.businessImg) {
            requestImage(this.IMG_BASR_URL + this.infoForm.businessImg).then(
              (result) => {
                let str = {
                  content: result,
                };
          ...
          if (this.infoForm.secondtypeImg) {
            requestImage(this.IMG_BASR_URL + this.infoForm.secondtypeImg).then(
              (result) => {
                let str = {
                  content: result,
                };
          ...
          if (this.infoForm.thirdImg) {
            requestImage(this.IMG_BASR_URL + this.infoForm.thirdImg).then(
              (result) => {
                let str = {
                  content: result,
                };
          ...
          if (this.infoForm.identityFrontPhoto) {
            requestImage(
              this.IMG_BASR_URL + this.infoForm.identityFrontPhoto
            ).then((result) => {
              let str = {
                content: result,
              };
              this.frontIDcard.push(str);
            });
            // this.frontIDcard.push({
            //   url: this.IMG_BASR_URL + this.infoForm.identityFrontPhoto,
            // });
          }
          if (this.infoForm.identityBackPhoto) {
            requestImage(
              this.IMG_BASR_URL + this.infoForm.identityBackPhoto
            ).then((result) => {
              let str = {
                content: result,
              };
              this.versoIDcard.push(str);
            });
            // this.versoIDcard.push({
            //   url: this.IMG_BASR_URL + this.infoForm.identityBackPhoto,
            // });
          }
          if (this.infoForm.storeImageList.length > 0) {
            // 店内环境
